  ...
  return {
    ...
    visitor: {
      ...
      JSXElement(path, stats) {
        ...
        const include = stats.opts && stats.opts.include || _optionsDefaults2.default.include;
        const exclude = stats.opts && stats.opts.exclude || _optionsDefaults2.default.exclude;
